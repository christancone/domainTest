  ...
  >
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      ...
      >
        ...
        <div>
          <p className="font-medium text-cyan-400">Company</p>
        ...
        <div>
          <p className="font-medium text-cyan-400">Helpful Links</p>
        ...
        <div>
          <p className="font-medium text-cyan-400">Legal</p>
    ...
    <p className="text-xs text-gray-500">
      &copy; 2023. DomainLK. All rights reserved.
    </p>
  </div>
</footer>
)
